                     ...
                     (
                            (
                                   (
                                          (
                                                 SELECT
                                                        wstx_alex_pool_volume.wstx_volume :: double precision
                                                 FROM
                                                        laplace.wstx_alex_pool_volume
                                                 WHERE
                                                        (
                                                 ...
                                                 SELECT
                                                        static_data_fwp.value :: double precision
                                                 FROM
                                   ...
                                   SELECT
                                          wstx_alex_pool_volume.alex_volume :: double precision
                                   FROM
                                          laplace.wstx_alex_pool_volume
                                   WHERE
                                          (
                     ...
                     (
                            (
                                   (
                                          (
                                                 SELECT
                                                        wstx_wbtc_pool_volume.wstx_volume :: double precision
                                                 FROM
                                                        laplace.wstx_wbtc_pool_volume
                                                 WHERE
                                                        (
                                   ...
                                   (
                                          (
                                                 SELECT
                                                        wstx_wbtc_pool_volume.alex_volume :: double precision
                                                 FROM
                                                        laplace.wstx_wbtc_pool_volume
                                                 WHERE
                                                        (
